...
const SendEmail = ({
  ...
  const [customizeSection, setCustomizeSection] = useState(false);
  ...
  return (
    <>
      ...
      {/* Modal Inner */}
      <div
        className={`w-full sm:w-2/4 bg-white ease-in-out fixed top-0 h-screen overflow-hidden z-50 ${
      ...
      >
        {/* Modal Head */}
        <div className="border-b-2 flex gap-4 items-center bg-head-pink px-3 py-6 sm:px-2 sm:py-3">
          <div>
            <RxCross1
          ...
          <div className="">
            <h1 className="text-sm sm:text-md font-semibold">{title}</h1>
          </div>
        </div>
        {/* Modal Body */}
        <div className="px-6 py-6 relative hide-scrollbar overflow-y-scroll h-screen">
            ...
            {customizeStatus ? (
              !customizeSection ? (
                <button
                  ...
                  onClick={() => setCustomizeSection(true)}
                >
                  <BiPencil /> Customize
                </button>
              ) : (
                <div className="flex gap-4">
                  <button
                    ...
                    onClick={() => setCustomizeSection(false)}
                  >
                    Cencel
                  </button>
                  <button
          ...
          <>
            {!customizeSection ? (
              <div className=" mt-8 h-96 rounded-xl overflow-hidden shadow-all">
                {/* Email Template Head */}
                <div className="bg-head-pink h-8 w-full flex gap-2 items-center px-2">
                ...
                {/* Email Template Body */}
                <div className="p-4">
                  <h1 className="text-sm">Customize Here</h1>
                </div>
              </div>
            ) : (
